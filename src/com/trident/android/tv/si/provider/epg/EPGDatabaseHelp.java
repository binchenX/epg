...
/* package */class EPGDatabaseHelp extends SQLiteOpenHelper {
	...
	// "com.trident.android.tv.si.provider.epg";
	// path for application mode
	// private static final String DATABASE_PATH = "/data/data/" + PACKAGE_NAME
	// + "/databases/";
	...
	private static String getDatbasePath() {
	...
	public interface Table {
		...
		public static final String BASIC_JOIN_TYPE = Table.BASIC
				+ " LEFT OUTER JOIN " + Table.TYPE
	...
	public interface BasicColumns {
		...
		public static final String CONCRETE_ID = Table.BASIC + "."
				+ EventsContract.Events._ID;
		public static final String CONCRETE_SECTION_GUID = Table.BASIC + "."
				+ EventsContract.Events.SECTION_GUID;// "sguid";
		public static final String CONCRETE_TSID = Table.BASIC + "."
				+ EventsContract.Events.TSID;
		public static final String CONCRETE_ONID = Table.BASIC + "."
				+ EventsContract.Events.ONID;
		public static final String CONCRETE_SERVICE_ID = Table.BASIC + "."
				+ EventsContract.Events.SERVICE_ID;
		public static final String CONCRETE_START_TIME = Table.BASIC + "."
				+ EventsContract.Events.START_TIME;
		public static final String CONCRETE_DURATION = Table.BASIC + "."
				+ EventsContract.Events.DURATION;
		public static final String CONCRETE_RUNNING_STATUS = Table.BASIC + "."
				+ EventsContract.Events.RUNNING_STATUS;
		public static final String CONCRETE_CA_MODE = Table.BASIC + "."
				+ EventsContract.Events.CA_MODE;
		public static final String CONCRETE_NAME = Table.BASIC + "."
				+ EventsContract.Events.NAME;
		public static final String CONCRETE_SHORT_DESCRIPTION = Table.BASIC
				+ "." + EventsContract.Events.SHORT_DESCRIPTION;
	...
	public interface ExtendedFTSColumns {
		...
		// public static final String EVENT_ID = "event_id";
		// public static final String DESCRIPTOR_NUMBER = "descriptor_number";
		// public static final String LAST_DESCRIPTOER_NUMER =
		// "last_descriptor_number";

	}

	public interface RatingColumns {
		public static final String CONCRETE_ID = Table.RATINGS + "."
				+ Events._ID;
		public static final String EVENT_ID = Table.RATINGS + "." + "eguid";
		public static final String CONCRETE_COUNTRY_CODE = Table.RATINGS + "."
				+ EventsContract.RatingColumns.COUNTRY_CODE;
		public static final String CONCRETE_RATING = Table.RATINGS + "."
				+ EventsContract.RatingColumns.RATING;
	}
	...
	public interface ContentTypeColumns {
		public static final String _ID = "_id";
		public static final String CONCRETE_LEVEL1 = Table.TYPE
				+ EventsContract.Events.LEVEL1;
		public static final String CONCRETE_LEVEL2 = Table.TYPE
				+ EventsContract.Events.LEVEL1;
	...
	public synchronized SQLiteDatabase getReadableDatabase() {
		try {
			...
			Log.d(TAG, "Trying to open database " + getDatbasePath()
					+ getDatabaseName());
			return SQLiteDatabase.openDatabase(getDatbasePath()
					+ getDatabaseName(), null, SQLiteDatabase.OPEN_READONLY);
	...
	boolean copyDatabaseFromAssetToDataDir() {
		...
		String outFileName = getDatbasePath() + this.dbName;

		Log.d(TAG, "copy database from apk to /data/data/package/database");

		try {
			// Open your local db ,which stored in the assert direct of the apk
